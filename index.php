...
function calcularArnazenamento($totalUsuarios)
{
    echo "<li>" . $totalUsuarios . " GB de armazenamento</li>";
}

function mudarEstiloBotao()
{
    $idade = 19;
    if ($idade < 18) {
        ...
        <div class="container">
            <div class="card-deck mb-3 text-center">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li>10 usuários</li>
                            <?php calcularArnazenamento(10) ?>
                            <li>Suporte por email</li>
                            <li>Acesso ao centro de ajuda</li>
                        </ul>
                        <?php mudarEstiloBotao() ?>
                    </div>
                </div>
                <div class="card mb-4 shadow-sm">
                    <div class="card-header">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">$<?php calcularDesconto("premio"); ?> <small class="text-muted">/ mês</small></h1>
                        <ul class="list-unstyled mt-3 mb-4">
                            <li>30 usuários</li>
                            <?php calcularArnazenamento(30) ?>
