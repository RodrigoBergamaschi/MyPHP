        ...
        $("#cep").blur(function () {
            ...
            if (cep != "") {
                ...
                if (validacep.test(cep)) {
                    ...
                    $("#logradouro").val("...").addClass(efeitoLoad);                    
                    $("#bairro").val("...").addClass(efeitoLoad);
                    $("#cidade").val("...").addClass(efeitoLoad);
                    $("#numero").val("...").addClass(efeitoLoad);
                    $("#uf").val("...").addClass(efeitoLoad);
                    $("#ibge").val("...").addClass(efeitoLoad);
                    ...
                    $.getJSON("https://viacep.com.br/ws/" + cep + "/json/?callback=?", function (dados) {
                        ...
                        if (!("erro" in dados)) {
                            ...
                            $("#numero").val("...").removeClass(efeitoLoad);
